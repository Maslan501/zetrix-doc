...
* [4.2 Component design](component-design.md)
* [4.3 Crypto architecture split](crypto-architecture-split.md)
* [4.4 Where Zetrix fits the x401 abstractions](where-zetrix-fits-the-x401-abstractions.md)
