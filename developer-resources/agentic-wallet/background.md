...
x401 was launched by Proof in June 2026 with technical contribution from Circle, OpenAI, Google, and Okta; the normative spec lives at x401.id. A separate community project, **claw401**, explores a wallet-authentication variant (Ed25519 canonical-JSON challenge/response with single-use TTL-bounded nonces, replay caching, scoped agent sessions) that informs our replay-resistance design in [Implementation approach](implementation-approach.md).
