...
* **Protocol**, [Motivation](motivation/), [Background](background.md), and an [x401 vs. x402](x401-vs-x402-at-a-glance.md) comparison.
...
* **Flows**, the [protocol flow](protocol-flow/) (messages, endpoints, POC payment) and the [message flows](message-flows/) (issuance, paid access, zero-knowledge proof).
* **Delivery**, the [implementation approach](implementation-approach.md), [security considerations](security-considerations.md), and [open items](open-items-and-decisions.md).
* **Reference**, the [appendix](appendix/): endpoints, glossary, and source material.
